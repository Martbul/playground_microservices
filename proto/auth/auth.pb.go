...
type RegisterRequest struct {
	...
	FisrtName     string                 `protobuf:"bytes,4,opt,name=fisrt_name,json=fisrtName,proto3" json:"fisrt_name,omitempty"`
	LastName      string                 `protobuf:"bytes,5,opt,name=last_name,json=lastName,proto3" json:"last_name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x15proto/auth/auth.proto\x12\x04auth\x1a\x19proto/common/common.proto\"\xf2\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\bisActive\x18\a \x01(\bR\bisActive\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"fisrt_name\x18\x04 \x01(\tR\tfisrtName\x12\x1b\n" +
